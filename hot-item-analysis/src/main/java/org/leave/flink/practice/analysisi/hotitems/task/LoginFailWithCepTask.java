...
import org.leave.flink.practice.analysisi.hotitems.function.LoginFailMatch;
...
//创建上下文环境
        ...
        // select出匹配到的事件
        SingleOutputStreamOperator<LoginWarning> loginFailDataStream = patternStream.select(new LoginFailMatch());
