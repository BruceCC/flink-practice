...
import org.leave.flink.practice.pageview.function.UvCountWithBloom;
import org.leave.flink.practice.pageview.trigger.UvTrigger;
...
public class UvWithBloomFilterTask {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<UvCount> dataStream = sourceStream.map((MapFunction<String, UserBehavior>) value -> {
            try {
                ...
                .map((MapFunction<UserBehavior, Tuple2<String, Long>>) value -> Tuple2.of("dummyKey", value.getUserId()))
